...
const defaultWords = ["Full Stack Developer", "UI/UX Enthusiast", "Next.js Expert", "Framer Motion Wiz"];
...
const Word = memo(function Word({
  ...
  return (
    <motion.div
      className={cn(
        "flex gap-[0.1em] text-2xl md:text-4xl font-bold uppercase tracking-wider text-neutral-800 dark:text-neutral-100",
        textClassName
      )}
      initial="initial"
      animate="animate"
